...
var data = { labels: ${pie1},
      datasets: [ { data: ${pie2},
         backgroundColor: [ "#f79546", "#9bba57", "#4f81bb", "#5f497a", "#a94069", "#ff5f34", "#41774e", "#003663", "#49acc5" ],
         borderWidth: 0,
         label: "Dataset 1",
         hoverOffset: 4 }] };
            ...
            <div class="content-wrapper">
               ...
               <div class="row">
                  ...
                  <div class="col-md-7 grid-margin transparent">
                     <div class="card card-dark-blue col-lg-12" style="vertical-align:middle;">
                        <div class="row" style="margin-top:30px;">
                           <div class="col-md-6 grid-margin stretch-card">
                              <div class="card">
                                 <div class="card-body">
                                    <p class="card-title mb-0">Top Word List(This Month)</p>
                                    <div class="table-responsive">
                                       <table class="table table-striped table-borderless">
                                          ...
                                          <tbody>
                                             <c:forEach var="one" items="${top_list1 }"
                                                varStatus="status">
                                                <tr>
                                                   <c:choose>
                                                      <c:when test="${status.count <= 3 }">
                                                         <td class="font-weight-bold"><span
                                                            style="font-size:${30 - 5*(status.count-1)};">${status.count }</span>
                                                         </td>
                                                         <td><span
                                                            style="font-size:${30 - 5*(status.count-1)};">${one}</span>
                                                         </td>
                                                      </c:when>
                                                      <c:otherwise>
                                                         <td><span
                                                            style="font-size: 18px; font-weight: bold;">${status.count }</span>
                                                         </td>
                                                         <td><span
                                                            style="font-size: 18px; font-weignt: bold;">${one}</span>
                                                         </td>
                                                      </c:otherwise>
                                                   </c:choose>
                           ...
                           <div class="col-md-6 grid-margin stretch-card">
                              <div class="card">
                                 <div class="card-body">
                                    <p class="card-title mb-0">Top Word List(Last Month)</p>
                                    <div class="table-responsive">
                                       <table class="table table-striped table-borderless">
                                          <thead>
                                             <tr>
                                          ...
                                          <tbody>
                                             <c:forEach var="one" items="${top_list2 }"
                                                varStatus="status">
                                                <tr>
                                                   <c:choose>
                                                      <c:when test="${status.count <= 3 }">
                     ...
                     <div class="card">
                        <div class="card-body">
                           <div class="row"
                              ...
                              <input type="button" class="btn btn-link btn-fw"
                                 onclick="location.href='${contextPath}/main/timeDetail.do'"
                                 value="상세보기">
                           </div>
                           <div class="row">
                     ...
                     <div class="card">
                        <div class="card-body">
                           <div class="row"
                              style="width: 100%; display: flex; justify-content: flex-end;">
                              <input type="button" class="btn btn-link btn-fw"
                                 onclick="location.href='${contextPath}/main/networkDetail.do'"
                                 value="상세보기">
                           </div>
                           <div class="row">
