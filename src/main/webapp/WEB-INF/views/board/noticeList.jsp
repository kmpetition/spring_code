   ...
   <td width="10%">${article.createdate }</td> --%>
                        ...
                        <div class="row">
                           ...
                           <div class="col-7 in_list">
                              <a
                                 href="${contextPath }/board/noticeDetail.do?articleNO=${article.articleNO}">${article.title }</a>
                           </div>
                              ...
                              <c:choose>
                                 <c:when test="${totNotice >100 }">
                                    ...
                                    <c:forEach var="page" begin="1"
                                       end="${totNotice/(section*100) >= 1 ? 10 : totNotice%((section-1)*100)/10+1 }"
                                       step="1">
                                       ...
                                       <c:if test="${page ==10 && totNotice > section*100 }">
                                          <li class="page-item"><a class="page-link"
                                             href="${contextPath }/board/noticeList.do?section=${section+1}&pageNum=1">&nbsp;
                                                다음</a></li>
                                       </c:if>
