...
<script type="text/javascript">
	...
	/* function fn_delete(obj, articleNO) {
		var action = "${contextPath}/admin/removeNotice.do?noticeNO=" + articleNO;
		obj.action = action;
		obj.method = "get";
		obj.submit();
	} */
	/* (본문)삭제하기 버튼 클릭 */
 	function fn_delete(obj, articleNO) {
		var action = "${contextPath}/admin/removeNotice.do?noticeNO="
				+ articleNO;
							...
							<div class="row bottom_button">
								...
								<%-- <div class="col-2">
									<button type="button" class=" btn btn-danger a3"
										onClick="fn_delete(this.form, '${noticeVO.articleNO}')">삭제</button>
								</div> --%>
							</div>
						</div>
					</div>
