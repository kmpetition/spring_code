...
<!-- CSS -->
<link rel="stylesheet"
	href="${contextPath}/resources/css/list_onebyone_detail.css"
	type="text/css">
...
<script type="text/javascript">
	...
	function fn_replyDelete(obj, articleNO) {
		var action = "${contextPath}/admin/removeReply.do?articleNO="
				+ articleNO;
		/* location.href=action; */
	...
	<form name="frmboardVO" method="post" action="${contextPath}"
		...
		<table border=0 align="center">
			...
			<tr>
				...
				<td><input type="text" value="${boardVO.id }" disabled /></td>
			</tr>
			...
			<tr>
				<td><input type=button value="리스트로 돌아가기"
					...
					value="수정하기" onClick="modArticle('${boardVO.articleNO}')">
					<input type=button value="삭제하기"
					onClick="fn_delete(this.form, '${boardVO.articleNO}')"> <a
					href="${contextPath }/board/removeBoard.do?articleNO=${boardVO.articleNO}"
					role="button">삭제</a> <input type=button value="답글쓰기"
					onClick="fn_replyForm('${boardVO.articleNO }')" /></td>
			</tr>
			<tr></tr>
		...
		<form name="frmReply" method="post" action="${contextPath}"
			...
			<table border=0 align="center">
				...
				<tr>
					...
					<td><input type=text name="title" value="${replyVO.title}"
						readonly="readonly" /></td>
				</tr>
				<tr>
					<td width="150" align="center" bgcolor="yellowgreen">내용</td>
					<td><input type=text name="content" value="${replyVO.content}"
						readonly="readonly" /></td>
				</tr>
				...
				<c:if test="${not empty uploadList}">
					<tr>
						...
						<td><c:forEach var="file" items="${replyUploadList }">
					${file.uploadfile }		
					<input type="button" value="파일다운로드"
									onClick="fileDownload('${contextPath }/downloadFile.do','${file.uploadfile }')" />
								</br>
				...
				<tr>
					<td><input type=button value="수정하기"
						onClick="modReply(this.form)"> <input type=button
						value="답글삭제"
						onClick="fn_replyDelete(this.form, '${boardVO.articleNO}')"></td>
				</tr>
						...
						<div class="col-10 alert alert-primary layer_content at_list">
							...
							<div class="row">
								<div class="col-12 text_filed">
									<textarea class="inside_text" id="story" name="story"
							...
							<div class="row bottom_button">
								...
								<div class="col-2">
									<button type="button" class=" btn btn-secondary a2"
										onClick="modArticle('${boardVO.articleNO}')">수정</button>
								</div>
								<div class="col-2">
								...
								<div>
									...
									onClick="fn_replyForm('${boardVO.articleNO }')" />
										<a href="${contextPath }/admin/replyForm"> 답글쓰기 </a>
									</c:if>
